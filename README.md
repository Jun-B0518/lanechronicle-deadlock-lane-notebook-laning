...
<div align="center">
  <img src="./public/logo.svg" alt="LaneChronicle — Deadlock — Laning" width="64" height="64">
  <h1>LaneChronicle — Deadlock — Laning</h1>
</div>

An independent project specification for Deadlock, covering lane review cards, item timing worksheets, patch annotation log.
...
<img src="./public/screenshots/desktop-main.svg" alt="Deadlock — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Deadlock — compact concept, not a screenshot" width="250">
<br>
...
- **Lane review cards** — planned module; not implemented.
- **Item timing worksheets** — planned module; not implemented.
- **Patch annotation log** — planned module; not implemented.

The proposed workflow separates lane review cards from item timing worksheets, with patch annotation log retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Lane review cards**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="LaneChronicle — Deadlock — Laning — specification review workflow">
<br>
...
Define the input and expected outcome for module 1. Record the Deadlock version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Item timing worksheets

Define the input and expected outcome for module 2. Record the Deadlock version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Patch annotation log

Define the input and expected outcome for module 3. Record the Deadlock version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
|---|---|
| Target | Deadlock |
| Category | Manual game companion |
| Input | Manual notes or user-authorized local exports |
| Planned output | Lane review cards |
